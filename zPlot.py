...
plt.plot(timearray,[12.621,30.809,45.402, 60.939, 74.219, 89.928, 105.938, 123.536, 141.933, 159.463],"k-.d",label="MultiAPT")
plt.plot(timearray,[19.57, 43.75, 81.17, 121.22, 161.35, 199.45, 239.11, 276.87, 314.57, 353.18],"g-.^",label="MultiLUCB")
